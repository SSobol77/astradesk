...
# Project: AstraDesk
# File: services/api-gateway/tests/runtime/test_memory.py
...
@pytest.mark.parametrize(
    'key, value, ttl', [('', 'val', 3600), ('key', 'val', 0), ('key', 'val', -1)]
)
...
@pytest.mark.parametrize(
    'actor, action, payload', [('', 'act', {}), ('act', '', {}), ('act', 'act', None)]
)
...
async def test_audit_db_error_is_critical_and_raised(
    memory_instance, mock_pg_pool, mock_events, caplog
):
    conn = mock_pg_pool.acquire.return_value.__aenter__.return_value
