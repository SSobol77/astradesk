...
class BaseAgent(ABC):
    ...
    self, query: str, context: Dict[str, Any]
        ...
        with self.tracer.start_as_current_span("agent_run") as span:
            ...
            # Przechodzimy po grafie kroków kolejką, aby obsłużyć replany (nowe węzły)
            ...
            while idx < len(queue):
                ...
                # OPA governance
                # Używamy lokalnego wrappera policy (spójnie z innymi agentami)
                opa_payload = {"action": step.name, "claims": context.get("claims")}
                opa_policy.authorize("tools.invoke", context.get("claims"), opa_payload)
                ...
                if score < 0.7:  # Low score → replan
                    ...
                    # Dołącz nowe kroki do grafu i kolejki
