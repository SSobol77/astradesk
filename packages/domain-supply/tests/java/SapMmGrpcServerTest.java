...
// Project: AstraDesk
// File: packages/domain-supply/tests/java/SapMmGrpcServerTest.java
// Website: https://www.astradesk.dev
// Repository: https://github.com/SSobol77/astradesk
//
// Description: Implements AstraDesk functionality for packages/domain-supply/tests/java/SapMmGrpcServerTest.java.
//
...
public class SapMmGrpcServerTest {
    @Rule
    ...
    void testFetchInventorySuccess() throws Exception {
        ...
        SapMmGrpcServer.SapMmGrpcServer server = new SapMmGrpcServer("http://" + apiServer.getHostName() + ":" + apiServer.getPort(), "test-token");
