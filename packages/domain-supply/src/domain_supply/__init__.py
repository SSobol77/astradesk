...
# Project: AstraDesk
# File: packages/domain-supply/src/domain_supply/__init__.py
...
"""Supply-chain domain pack discovery contract."""

from __future__ import annotations


class Pack:
    """Discovery adapter for the standalone supply-chain MCP server."""
