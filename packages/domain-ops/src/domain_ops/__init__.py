...
# Project: AstraDesk
# File: packages/domain-ops/src/domain_ops/__init__.py
...
"""Operations domain pack discovery contract."""

from __future__ import annotations


class Pack:
    """Discovery adapter for the standalone operations MCP server."""
