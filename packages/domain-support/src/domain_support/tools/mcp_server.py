...
# Project: AstraDesk
# File: packages/domain-support/src/domain_support/tools/mcp_server.py
# Website: https://www.astradesk.dev
# Repository: https://github.com/SSobol77/astradesk
#
# Description: Implements AstraDesk functionality for packages/domain-support/src/domain_support/tools/mcp_server.py.
#
        ...
        'tools': [
            {
                ...
                'parameters': {
                    'type': 'object',
                    'properties': {'jql': {'type': 'string', 'description': 'JQL query string'}},
                    'required': ['jql'],
                },
            },
            {
