...
class ToolCall(AstraDeskBaseModel):
    def __init__(self, *, name: str, arguments: dict[str, Any] | None = None, **extra: Any):
        if extra:
...
class AgentResponse(AstraDeskBaseModel):
    def __init__(
        ...
        *,
        ...
        invoked_tools: Sequence[dict[str, Any] | ToolCall] | None = None,
    ...
    def _dump(self) -> dict[str, Any]:
        payload = {
            ...
            'invoked_tools': [tool._dump() for tool in self.invoked_tools]
