...
# Project: AstraDesk
# File: src/runtime/memory.py
# Website: https://www.astradesk.dev
# Repository: https://github.com/SSobol77/astradesk
#
# Description: Implements AstraDesk functionality for src/runtime/memory.py.
#
...
class Memory:
    ...
    async def store_dialogue(
        self, agent: str, query: str, answer: str, meta: dict[str, Any] | None
    ) -> None:
    ...
    async def audit(self, actor: str, action: str, payload: dict[str, Any]) -> None:
        ...
        try:
            await events.publish(
                AUDIT_SUBJECT, {'actor': actor, 'action': action, 'payload': payload}
            )
        except Exception as exc:  # - best-effort semantics
