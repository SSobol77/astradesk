...
# Project: AstraDesk
# File: mcp/src/gateway/main.py
# Website: https://www.astradesk.dev
# Repository: https://github.com/SSobol77/astradesk
#
# Description: Implements AstraDesk functionality for mcp/src/gateway/main.py.
#
...
def create_default_config() -> GatewayConfig:
    ...
    return GatewayConfig(
        ...
        oidc=OIDCConfig(issuer=oidc_issuer, audience=oidc_audience, jwks_url=oidc_jwks_url),
        tools=tools,
        audit=AuditConfig(
            sink=audit_sink, hash_algo=audit_hash_algo, retention_days=audit_retention_days
        ),
    )
